            ...
            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 919px;">
                <ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
                    ...
                    <li class="nav-item @if(Request::is('matieres')) active @endif">
                        <a href="{{ route('matieres.index') }}" class="nav-link"> <svg xmlns="http://www.w3.org/2000/svg" width="24"
                    ...
                    <li class="nav-item @if(Request::is('archives')) active @endif">
                        <a href="{{ route('archives.index') }}" class="nav-link"> <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" class="feather feather-book">
                                <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path>
                                <path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path>
                            </svg>
                            <span class="title">الأرشيف</span> 
                        </a>
                    </li>
